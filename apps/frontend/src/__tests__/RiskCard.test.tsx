...
const makeRisk = (overrides: Partial<RiskPayload> = {}): RiskPayload => ({
...
describe('RiskCard', () => {
  ...
  it('renders the severity badge', () => {
    render(<RiskCard risk={makeRisk({ severity: 'high' })} />)
  ...
  it('renders no links section when links array is empty', () => {
    render(<RiskCard risk={makeRisk({ links: [] })} />)
